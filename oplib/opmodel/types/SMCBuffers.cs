// SMCBuffers.cs --- Part of the project OPLib 1.0, a high performance pricing library
...
namespace OPModel
{
    public class SMCBuffers
    {

        public CArray _device_m_k;						
        public CArray _device_xtpk_yy_j;				
        public CArray _device_xtpkbuf_yy_idx;			
        public CArray _device_tpk_yy_m;
        public CArray _device_ctpk_yy_m;
        public CArray _device_rgstatus;
        public int[] _host_hash_ys_m;
        public double[] host_d_xtpk_yy_j;				
        public double[] host_d_xtpkbuf_yy_idx;			
        public double[] host_d_tpk_yy_m;
        public double[] host_d_ctpk_yy_m;
        public double[] host_d_tpkbuf_ky;				
        public uint[] host_unif_scen_th;
        public short[] host_y_sk_th;
