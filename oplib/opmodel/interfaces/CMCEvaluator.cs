...
namespace OPModel
{
    ...
    unsafe public delegate void mc_eval_delegate(short* y_sk, int th, int batch);


    abstract public class CMCEvaluator
    {
        ...
        public CMCEvaluator()
        {
            unsafe
            {
                _eval = mc_eval_implementation;
            }
        }

        private mc_eval_delegate _eval;

        public mc_eval_delegate eval
        {
            get
            {
                return _eval;
        ...
        abstract public unsafe void mc_eval_implementation(short* y_sk, int th, int batch);
