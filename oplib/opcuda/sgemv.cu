// sgemv.cu --- Part of the project OPLib 1.0, a high performance pricing library
...
extern "C" __declspec( dllexport ) void opcuda_sgemv(int m, int n, float alpha,
                            const unsigned Aptr, int lda, const unsigned xptr, int incx,
                            float beta, unsigned yptr, int incy)
{	

	cublasSgemv ('N', m, n, alpha, (float *) Aptr, lda, (float *) xptr, incx, beta, (float *) yptr, incy);
                            
}



extern "C" __declspec( dllexport ) void opcuda_sgemvT(int m, int n, float alpha,
                            const unsigned Aptr, int lda, const unsigned xptr, int incx,
                            float beta, unsigned yptr, int incy)
{	

	cublasSgemv ('T', m, n, alpha, (float *) Aptr, lda, (float *) xptr, incx, beta, (float *) yptr, incy);
