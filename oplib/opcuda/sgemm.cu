// sgemm.cu --- Part of the project OPLib 1.0, a high performance pricing library
...
extern "C" __declspec( dllexport ) void opcuda_sgemm(int m, int n, int k, float alpha, unsigned APtr, int lda, unsigned BPtr, int ldb, float beta, unsigned CPtr, int ldc)
{	
    cublasSgemm('N', 'N', m, n, k, alpha, (float *) APtr, lda, (float *) BPtr, ldb, beta, (float *) CPtr, ldc );
}	
